...
class CreateProductSpecialPricesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('product_special_prices', function (Blueprint $table) {
            ...
            $table->primary(['delivery_destination_code', 'factory_code', 'product_code', 'currency_code', 'application_started_on'], 'product_special_prices_primary');
