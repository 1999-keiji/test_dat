...
class RecreateOrderHistories extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('order_histories', function (Blueprint $table) {
            ...
            $table->datetime('registration_date')->comment('登録日時');
            ...
            $table->unsignedInteger('product_weight')->default(0)->comment('商品重量');
            ...
            $table->primary(['order_number', 'registration_date']);
        });
    }
