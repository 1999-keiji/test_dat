...
class CreateFactoryPanelsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('factory_panels', function (Blueprint $table) {
            ...
            $table->primary(['factory_code', 'number_of_holes']);
    ...
    {
        Schema::dropIfExists('factory_panels');
    }
}
