...
<template>
  <div>
    ...
    <modal title="注文データ追加" effect="fade" large v-model="showModal">
      <form id="add-order-input-form" class="form-horizontal basic-form" :action="routeAction" method="POST">
        <div class="row">
            ...
            <div class="row form-group">
              ...
              <div class="col-md-7 col-sm-7 col-xs-7">
                <span class="shown_label">
                  ...
                  <input name="received_date" type="hidden" :value="searchParams.received_date">
                </span>
              </div>
            </div>
          </div>
            ...
            <div class="row form-group">
              ...
              <div class="col-md-7 col-sm-7 col-xs-7">
                <span class="shown_label">
                  ...
                  <input name="customer_code" type="hidden" :value="searchParams.customer_code">
                </span>
              </div>
            </div>
          </div>
            ...
            <div class="row form-group">
              ...
              <div class="col-md-7 col-sm-7 col-xs-7">
                <span class="shown_label">
                  ...
                  <input name="end_user_code" type="hidden" :value="searchParams.end_user_code">
                </span>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-5 col-sm-5 col-xs-6 col-md-offset-1 col-sm-offset-1">
            <div class="row form-group">
              <label class="col-md-5 col-sm-5 col-xs-5 control-label">納入先</label>
              <div class="col-md-7 col-sm-7 col-xs-7">
                <span class="shown_label">
        ...
        <div class="row">
          ...
          <div class="col-md-5 col-sm-5 col-xs-6 col-md-offset-1 col-sm-offset-1">
            <div class="row form-group">
              ...
              <div class="col-md-7 col-sm-7 col-xs-7">
                <span class="shown_label">{{ this.customerRecivedOrderUnit }}</span>
                <input name="customer_received_order_unit" type="hidden" :value="customerRecivedOrderUnit">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-5 col-sm-5 col-xs-6 col-md-offset-1 col-sm-offset-1">
            <div class="row form-group">
              ...
              <div class="col-md-7 col-sm-7 col-xs-7 form-inline">
                <input class="form-control text-left ime-inactive" type="text" maxlength="10" name="base_plus_order_number" :value="oldParams.base_plus_order_number">
                <input class="form-control text-left ime-inactive" type="text" maxlength="3" name="base_plus_order_chapter_number" :value="oldParams.base_plus_order_chapter_number">
              </div>
            </div>
          </div>
          <div class="col-md-5 col-sm-5 col-xs-6 col-md-offset-1 col-sm-offset-1">
            <div class="row form-group">
              <label for="end_user_order_number" class="col-md-5 col-sm-5 col-xs-5 control-label">
                エンドユーザ注文番号
              </label>
              <div class="col-md-5 col-sm-5 col-xs-6">
                <input class="form-control text-left ime-inactive" type="text" maxlength="17" name="end_user_order_number" :value="oldParams.end_user_order_number">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-5 col-sm-5 col-xs-6 col-md-offset-1 col-sm-offset-1">
            <div class="row form-group">
              ...
              <div class="col-md-7 col-sm-7 col-xs-7">
                <textarea class="form-control text-left ime-active remark-text" cols="25" rows="4" maxlength="50" name="order_message" v-model="oldParams.order_message"></textarea>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  data: function () {
    return {
      ...
      factory: null,
      customer: null,
      deliveryDate: this.oldParams.delivery_date || '',
      factoryProducts: [],
      factoryProduct: {},
      currency: null,
      orderQuantity: this.oldParams.order_quantity || '',
      orderUnit: this.oldParams.order_unit || '',
      receivedOrderUnit: this.oldParams.received_order_unit || '',
  ...
  created: function () {
    ...
    this.currency = this.currencies
      .filter(c => c.currency_code === this.oldParams.currency_code || this.defaultCurrencyCode)[0]
  ...
  computed: {
    ...
    customerRecivedOrderUnit: function () {
  ...
  methods: {
    getFactoryProducts: function () {
      ...
      if (! this.searchParams.factory_code || ! this.searchParams.delivery_destination_code) {
        return
      }

      axios.get('/api/get-delivery-factory-products', {
        params: {
          factory_code: this.searchParams.factory_code,
          delivery_destination_code: this.searchParams.delivery_destination_code
        }
      })
        .then(response => {
          ...
          const factoryProductSequenceNumber = this.oldParams.factory_product_sequence_number ||
            this.searchParams.factory_product_sequence_number
    ...
    submitForm: function () {
      if (confirm('データを登録しますか?')) {
        ...
        $('.alert').remove()
        document.getElementById('add-order-input-form').submit()
      }
    }
  }
}
