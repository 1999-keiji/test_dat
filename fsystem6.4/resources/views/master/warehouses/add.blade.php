...
@section('breadcrumbs')
  ...
  <li>{{ __('view.master.warehouses.add') }}</li>
@endsection

@section('content')
<form id="save-warehouse-form" class="form-horizontal basic-form save-data-form" action="{{ route('master.warehouses.create') }}" method="POST">
  <div class="row">
  ...
  <div class="row">
    <div class="col-md-5 col-sm-5 col-xs-6 col-md-offset-1 col-sm-offset-1">
      <div class="row form-group">
        <label for="warehouse_code" class="col-md-4 col-sm-4 col-md-offset-1 col-sm-offset-1 control-label required">
        ...
        <div class="col-md-7 col-sm-7">
          <input
            id="warehouse_code"
            class="form-control ime-inactive {{ has_error('warehouse_code') }}"
            maxlength="{{ $warehouse_code->getMaxLength() }}"
            name="warehouse_code"
            type="text"
            value="{{ old('warehouse_code') }}"
            data-toggle="tooltip"
            title="{{ replace_el($warehouse_code->getHelpText()) }}"
            required>
        </div>
      </div>
    </div>
      ...
      <div class="row form-group">
        ...
        <div class="col-md-7 col-sm-7">
          <input
            ...
            type="text"
            value="{{ old('warehouse_abbreviation') }}"
            required>
        </div>
      </div>
    </div>
