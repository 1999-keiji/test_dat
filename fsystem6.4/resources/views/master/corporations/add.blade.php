...
@section('title')
{{ __('view.master.corporations.add') }}
@endsection
...
@section('breadcrumbs')
  ...
  <li>{{ __('view.master.corporations.add') }}</li>
@endsection

@section('content')
<form id="save-corporation-form" class="form-horizontal basic-form save-data-form" action="{{ route('master.corporations.create') }}" method="POST">
  <div class="row">
  ...
  <div class="row">
    <div class="col-md-5 col-sm-5 col-xs-6 col-md-offset-1 col-sm-offset-1">
      <div class="row form-group">
        <label for="corporation_code" class="col-md-4 col-sm-4 col-md-offset-1 col-sm-offset-1 control-label required">
        ...
        <div class="col-md-7 col-sm-7">
          <input
            id="corporation_code"
            class="form-control text-center ime-inactive {{ has_error('corporation_code') }}"
            maxlength="{{ $corporation_code->getMaxLength() }}"
            name="corporation_code"
            type="text"
            value="{{ old('corporation_code') }}"
            data-toggle="tooltip"
            title="{{ replace_el($corporation_code->getHelpText()) }}"
            required>
        </div>
      </div>
    </div>
    <div class="col-md-5 col-sm-5 col-xs-6">
      <div class="row form-group">
        ...
        <div class="col-md-7 col-sm-7">
          <input id="corporation_name" class="form-control ime-active {{ has_error('corporation_name') }}" maxlength="50" name="corporation_name" type="text" value="{{ old('corporation_name') }}" required>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-5 col-sm-5 col-xs-6 col-md-offset-1 col-sm-offset-1">
      <div class="row form-group">
        ...
        <div class="col-md-7 col-sm-7">
          <input id="corporation_abbreviation" class="form-control ime-active {{ has_error('corporation_abbreviation') }}" maxlength="20" name="corporation_abbreviation" type="text" value="{{ old('corporation_abbreviation') }}" required>
        </div>
      </div>
    </div>
    <div class="col-md-5 col-sm-5 col-xs-6">
