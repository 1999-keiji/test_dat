...
@section('breadcrumbs')
  ...
  <li>{{ __('view.master.customers.add') }}</li>
@endsection

@section('content')
<form id="save-customer-form" class="form-horizontal basic-form save-data-form" action="{{ route('master.customers.create') }}" method="POST">
  <div class="row">
      ...
      <div class="row form-group">
        ...
        <div class="col-md-7 col-sm-7">
          <input id="customer_code"
                 class="form-control ime-inactive {{ has_error('customer_code') }}"
                 maxlength="{{ $customer_code->getMaxLength() }}"
                 name="customer_code"
                 type="text"
                 value="{{ old('customer_code') }}"
                 data-toggle="tooltip"
                 title="{{ replace_el($customer_code->getHelpText()) }}"
                 required>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-md-5 col-sm-5 col-xs-6 col-md-offset-1 col-sm-offset-1">
      <div class="row form-group">
        ...
        <div class="col-md-7 col-sm-7">
          <input id="customer_name" class="form-control ime-active {{ has_error('customer_name') }}" maxlength="50" name="customer_name" type="text" value="{{ old('customer_name') }}" required>
        </div>
      </div>
    </div>
    <div class="col-md-5 col-sm-5 col-xs-6">
      <div class="row form-group">
        ...
        <div class="col-md-7 col-sm-7">
          <input id="customer_name2" class="form-control ime-active {{ has_error('customer_name2') }}" maxlength="50" name="customer_name2" type="text" value="{{ old('customer_name2') }}">
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-5 col-sm-5 col-xs-6 col-md-offset-1 col-sm-offset-1">
      <div class="row form-group">
        ...
        <div class="col-md-7 col-sm-7">
          <input id="customer_abbreviation" class="form-control ime-active {{ has_error('customer_abbreviation') }}" maxlength="20" name="customer_abbreviation" type="text" value="{{ old('customer_abbreviation') }}" required>
        </div>
      </div>
    </div>
    <div class="col-md-5 col-sm-5 col-xs-6">
      <div class="row form-group">
        ...
        <div class="col-md-7 col-sm-7">
          <input id="customer_name_kana" class="form-control ime-active {{ has_error('customer_name_kana') }}" maxlength="30" name="customer_name_kana" type="text" value="{{ old('customer_name_kana') }}" required>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-5 col-sm-5 col-xs-6 col-md-offset-1 col-sm-offset-1">
      <div class="row form-group">
        ...
        <div class="col-md-7 col-sm-7">
          <input id="customer_name_english" class="form-control ime-inactive {{ has_error('customer_name_english') }}" maxlength="65" name="customer_name_english" type="text" value="{{ old('customer_name_english') }}" required>
        </div>
      </div>
    </div>
    <div class="col-md-5 col-sm-5 col-xs-6">
      ...
      <div class="row form-group">
        ...
        <div class="col-md-7 col-sm-7">
          <select id="closing_date" class="form-control {{ has_error('closing_date') }}" name="closing_date" required>
            ...
            <option value="{{ $value }}" {{ is_selected($value, old('closing_date')) }}>{{ $label }}</option>
            @endforeach
          </select>
        </div>
      </div>
      ...
      <div class="row form-group">
        ...
        <div class="col-md-7 col-sm-7">
          <select id="payment_timing_month" class="form-control {{ has_error('payment_timing_month') }}" name="payment_timing_month" required>
            ...
            <option value="{{ $value }}" {{ is_selected($value, old('payment_timing_month')) }}>{{ $label }}</option>
            @endforeach
          </select>
          <select id="payment_timing_date" class="form-control {{ has_error('payment_timing_date') }}" name="payment_timing_date" required>
            ...
            <option value="{{ $value }}" {{ is_selected($value, old('payment_timing_date')) }}>{{ $label }}</option>
            @endforeach
          </select>
        </div>
      </div>
      ...
      <div class="row form-group">
        ...
        <div class="col-md-7 col-sm-7">
          <select id="basis_for_recording_sales" class="form-control {{ has_error('basis_for_recording_sales') }}" name="basis_for_recording_sales" required>
            ...
            <option value="{{ $value }}" {{ is_selected($value, old('basis_for_recording_sales')) }}>{{ $label }}</option>
            @endforeach
          </select>
        </div>
      </div>
      ...
      <div class="row form-group">
        ...
        <div class="col-md-7 col-sm-7">
          <select id="rounding_type" class="form-control {{ has_error('rounding_type') }}" name="rounding_type" required>
            ...
            <option value="{{ $value }}" {{ is_selected($value, old('rounding_type')) }}>{{ $label }}</option>
            @endforeach
          </select>
        </div>
      </div>
      ...
      <div class="row form-group">
        ...
        <div class="col-md-7 col-sm-7">
          ...
          <label class="radio-inline">
            <input type="radio" name="order_cooperation" id="order_cooperation_{{ $value }}" value="{{ $value }}" {{ is_checked($value, old('order_cooperation', 1)) }}>{{ $label }}
          </label>
          @endforeach
        </div>
      </div>
