...
<body>
  <table>
    <tr>
      <th colspan="{{ 2 + count($simulatable_dates) * 3 }}" align="center">
    ...
    <tbody>
      ...
      @foreach (range($growth_simulation->factory_species->factory->number_of_floors, 1) as $floor)
        ...
        <tr>
          @if ($loop->first)
          <th
            rowspan="{{ $growth_simulation->factory_species->factory->number_of_floors }}"
            align="center"
            valign="middle"
        ...
        <tr>
          ...
          @foreach ($simulatable_dates as $idx => $sd)
            <td style="border-left: {{ $border }};
              ...
              }, range(0, ($growth_simulation->factory_species->factory->number_of_floors - 1)))) }})
            </td>
            <td
              align="right"
