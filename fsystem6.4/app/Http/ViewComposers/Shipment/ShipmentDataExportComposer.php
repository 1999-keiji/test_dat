...
class ShipmentDataExportComposer
{
    /**
     ...
     * @return void
     */
    public function __construct(FactoryService $factory_service, CustomerService $customer_service)
    {
    ...
    public function compose(View $view): void
    {
        $view->with([
            ...
            'shipment_data_export_file' => new ShipmentDataExportFile()
        ]);
    }
}
