...
class ExportStockStatesRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'export_type' => ['bail', 'required', 'in:current,past'],
            'stock_date' => ['bail', 'required_if:export_type,past', 'date_format:Y/m/d', 'before:today']
        ];
    }
    ...
    {
        return [
            'stock_date.required_if' => '過去状況の場合、日付を入力してください。',
            'stock_date.before' => '日付には、本日以前を指定してください。'
        ];
    }
}
