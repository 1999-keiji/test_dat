...
class UpdateManualCreatedOrderRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'delivery_date' => ['bail', 'required', 'date', 'max:10'],
            ...
            'order_quantity' => ['bail', 'required', 'numeric', 'max:99999'],
            'order_unit' => [
                'bail',
                'required',
